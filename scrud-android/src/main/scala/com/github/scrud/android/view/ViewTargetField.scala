...
import com.github.scrud.copy.{NestedTargetField, CopyContext, TypedTargetField}
 ...
 */
abstract class ViewTargetField[T <: View,V](val defaultLayout: NodeSeq) extends TypedTargetField[T,V] {
  ...
  def forTargetView(viewSpecifier: ViewSpecifier): NestedTargetField[V] =
    new NestedTargetField[V](viewSpecifier, this)
}
